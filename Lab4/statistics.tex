...
\begin{table}[h]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{3cm}
        ...
        \midrule
        \rowcolor{altrow}
        descending.out & 277 & 443 & 0.625 & 1.599 & 74  & 176 \\
        evenorodd.out  & 6   & 16  & 0.375 & 2.667 & 6   & 0   \\
        \rowcolor{altrow}
        fibonacci.out  & 78  & 118 & 0.661 & 1.512 & 20  & 32  \\
        palindrome.out & 49  & 107 & 0.458 & 2.183 & 47  & 14  \\
        \rowcolor{altrow}
        prime.out      & 29  & 53  & 0.547 & 1.828 & 15  & 10  \\
        \bottomrule
    \end{tabular}
