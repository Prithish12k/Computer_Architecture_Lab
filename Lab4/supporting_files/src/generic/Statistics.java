...
public class Statistics {
	...
	static float ipc;
	static float cpi;
    static int dataHazardStalls;
    static int wrongBranchCount;
	...
	public static void printStatistics(String statFile)
	{
		try
		{
            ...
            writer.println("Number of Data Hazard Stalls = " + dataHazardStalls);
            writer.println("Number of Wrong Branch Instructions that entered the pipeline = " + 2*wrongBranchCount);
			writer.close();
		}
		catch(Exception e)
		{
